    ...
    <div className="flex-1 flex flex-col items-center justify-center px-6 py-10 bg-cream dark:bg-gray-900 overflow-y-auto">
      <div className="w-full max-w-md animate-message-in">
        ...
        <div className="space-y-5">
          {/* Subject */}
          <div>
            <label className="block text-sm font-jakarta font-semibold text-gray-700 dark:text-gray-200 mb-1.5">
              Subject
            </label>
            <select
              value={subject}
          ...
          {error && (
            <p className="text-sm text-red-500 font-jakarta text-center">{error}</p>
          )}
