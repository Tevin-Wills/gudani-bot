...
export default function QuestionCard({
  ...
  return (
    <div className="flex-1 flex flex-col bg-cream dark:bg-gray-900 overflow-y-auto">
      ...
      {/* Question */}
      <div className="px-6 py-4 animate-slide-in">
        ...
        {(question.type === "mcq" || question.type === "true_false") && (
          <div className={`space-y-3 ${question.type === "true_false" ? "grid grid-cols-2 gap-3 space-y-0" : ""}`}>
        ...
        {/* Feedback */}
        {answered && feedback && (
          <div className={`mt-5 p-4 rounded-xl animate-message-in ${
            feedback.correct
